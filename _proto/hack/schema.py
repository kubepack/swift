...
REPO_ROOT = expandvars("$GOPATH/src/github.com/appscode/lever/_proto")
...
def generate_url_summary():
    ...
    for root, dirnames, filenames in os.walk(REPO_ROOT):
        for filename in fnmatch.filter(filenames, '*.proto'):
            ...
            rel_proto = proto[proto.index('github.com/appscode/lever/_proto') + len('github.com/appscode/lever/_proto'):]
            with open(proto) as f:
                content = f.read()
