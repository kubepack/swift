...
### Using Script
Swift can be installed via installer script included in the [/hack/deploy](https://github.com/kubepack/swift/tree/{{< param "info.version" >}}/hack/deploy) folder.

```console
$ curl -fsSL https://raw.githubusercontent.com/appscode/swift/{{< param "info.version" >}}/hack/deploy/swift.sh | bash
```
...
```console
$ curl -fsSL https://raw.githubusercontent.com/appscode/swift/{{< param "info.version" >}}/hack/deploy/swift.sh | bash -s -- -h
...
### Using Helm
Swift can be installed via [Helm](https://helm.sh/) using the [chart](https://github.com/kubepack/swift/tree/{{< param "info.version" >}}/chart/swift) from [AppsCode Charts Repository](https://github.com/appscode/charts). To install the chart with the release name `my-release`:
...
appscode/swift  {{< param "info.version" >}}         {{< param "info.version" >}}       Swift by AppsCode - Ajax friendly Helm Tiller Proxy

$ helm install appscode/swift --name swift --version {{< param "info.version" >}}
```

To see the detailed configuration options, visit [here](https://github.com/kubepack/swift/tree/{{< param "info.version" >}}/chart/swift/).
